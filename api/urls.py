...
urlpatterns = [
    ...
    path(
        "collaboratorsProjectList",
        views.collaboratorsProjectList,
        name="collaboratorsProjectList",
    ),
    path("projectView/<int:projectId>", views.projectView, name="projectView"),
    path(
        "projectHandling/<int:projectId>", views.projectHandling, name="projectHandling"
    ),
    ...
    path(
        "projectCollaborators/<int:projectId>",
        views.projectCollaborators,
